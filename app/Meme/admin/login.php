...
if($_POST['uname'] == $adminUser && $_POST['upass'] == $adminPass)
{
	$expire=time()+60*60*24*30;
	setcookie("memeuser", $adminUser, $expire);
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post">
        ...
        <input type="password" class="input-block-level" placeholder="Password" name="upass">
